...
trait MagicDrawUMLClassifier 
  ...
  def getMagicDrawClassifier: Uml#Classifier = e
  override implicit val umlOps: MagicDrawUMLUtil = ops
  import umlOps._
    
  override def templateParameter
  : Option[UMLClassifierTemplateParameter[Uml]]
  ...
  override def isFinalSpecialization: Boolean = e.isFinalSpecialization

  override def general_classifier
  ...
  override def powertypeExtent
  : Set[UMLGeneralizationSet[Uml]]
  = e.getPowertypeExtent.to[Set]

  override def useCase
  : Set[UMLUseCase[Uml]]
  = e.getUseCase.to[Set]
  
  override def classifier_readIsClassifiedObjectAction
  : Set[UMLReadIsClassifiedObjectAction[Uml]]
  = e.get_readIsClassifiedObjectActionOfClassifier.to[Set]
  
  override def realizingClassifier_componentRealization
  : Set[UMLComponentRealization[Uml]]
  = e.get_componentRealizationOfRealizingClassifier.to[Set]
  
  override def classifier_readExtentAction
  : Option[UMLReadExtentAction[Uml]]
  = {
  ...
  override def unmarshallType_unmarshallAction
  : Set[UMLUnmarshallAction[Uml]]
  = e.get_unmarshallActionOfUnmarshallType.to[Set]
  
  override def represented_representation
  : Set[UMLInformationItem[Uml]]
  = e.get_informationItemOfRepresented.to[Set]
  
  override def newClassifier_reclassifyObjectAction
  : Set[UMLReclassifyObjectAction[Uml]]
  = e.get_reclassifyObjectActionOfNewClassifier.to[Set]
  
  override def oldClassifier_reclassifyObjectAction
  : Set[UMLReclassifyObjectAction[Uml]]
  = e.get_reclassifyObjectActionOfOldClassifier.to[Set]
  
  override def contract_substitution
  : Set[UMLSubstitution[Uml]]
  = e.get_substitutionOfContract.to[Set]
  
  override def redefinitionContext_redefinableElement
  : Set[UMLRedefinableElement[Uml]]
  = e.get_redefinableElementOfRedefinitionContext.to[Set]
  
  override def classifier_instanceSpecification
  : Set[UMLInstanceSpecification[Uml]]
  = e.get_instanceSpecificationOfClassifier.to[Set]
  
  override def exceptionType_exceptionHandler
  : Set[UMLExceptionHandler[Uml]]
  = e.get_exceptionHandlerOfExceptionType.to[Set]
  
  override def constrainingClassifier_classifierTemplateParameter
  : Set[UMLClassifierTemplateParameter[Uml]]
  = e.get_classifierTemplateParameterOfConstrainingClassifier.to[Set]
  
  override def conveyed_conveyingFlow
  ...
  override def classifier_createObjectAction
  : Set[UMLCreateObjectAction[Uml]]
